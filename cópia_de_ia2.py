...
Original file is located at
    https://colab.research.google.com/drive/1yp4oTdV68aoDOXs25RUxM5Hgc28QEPkB
"""

import pandas as pd

dados = pd.read_csv('arvoreDecisao.csv',
                    sep=';')
dados.info()
...
if st.button('Rodar a arvore'):

	#testar a árvore
	predicao = arvore.predict([individuo])
	st.write('O animal previsto pela arvore é: ' + nomes_classes[predicao])
